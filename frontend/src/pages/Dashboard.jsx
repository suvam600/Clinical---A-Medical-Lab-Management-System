...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    if (payment === "success") {
      ...
      // no failed payment message shown
      setPaymentMessage("");
      setPaymentMessageType("");
    }

    // clean URL so ?payment=failed or ?payment=success disappears
    if (location.search) {
  ...
  return (
    <div className="max-w-6xl">
      {paymentMessage && paymentMessageType === "success" ? (
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      <span className={statusPill(x.status)}>
